...
✨ NgVirtualList Book Reader Demo (ng-virtual-list-book-reader) is an Angular-based showcase application designed to demonstrate high-performance rendering of long message history using virtual scrolling techniques.
